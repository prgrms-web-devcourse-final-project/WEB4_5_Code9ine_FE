...
export default function AiChat() {
  ...
  return (
    <>
      <div className="relative mt-[16px] flex h-[70px] max-h-[400px] w-[350px] flex-col items-center overflow-y-auto rounded-[10px] bg-[var(--white-color)] shadow-md transition-[height] focus-within:h-[500px]">
        {/* {!showIcon ? (
