...
export default function PostWriteForm() {
  return (
    <div className="flex w-full max-w-[724px] items-start gap-4 rounded-[10px] bg-[var(--background)] p-4 text-[20px] text-[var(--text-color-white)] shadow">
      ...
      <div className="flex flex-1 flex-col gap-2">
        ...
        <div className="relative h-[140px] w-full">
          ...
          />
          <button className="absolute right-[10px] bottom-[10px] z-10 h-[28px] w-[58px] cursor-pointer rounded-[20px] bg-[var(--main-color-1)] text-[16px] text-black transition-colors hover:bg-[var(--main-color-2)]">
            작성
          </button>
        </div>
      </div>
