...
export default function SignupBox() {
  ...
  return (
    <div className="flex h-auto w-[280px] flex-col gap-[5px] rounded-[20px] bg-[var(--background)] p-8 pt-[50px] pb-[50px] md:h-auto md:w-auto">
      {/* 이름 입력 */}
      <div className="flex flex-col gap-5 md:w-[700px] md:flex-row">
